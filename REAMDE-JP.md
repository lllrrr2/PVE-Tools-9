...
>
> **`main` ブランチ（Shell 版）は v8.8.8 を最後に更新を終了します。今後の開発は Go 版（[beta-go](https://github.com/Mapleawaa/PVE-Tools-9/tree/beta-go) ブランチ）に移行します。Go 版は引き続き無料でオープンソースとして提供されます。**
